                ...
                <div class="infrastructure">
                    ...
                    <div class="infrastructure-blocks-container">
                        ...
                        <div class="infrastructure-single-block">
                            ...
                            <div class="infrastructure-block-header">
                                <span>центральная канализация</span>
                            </div>
                        </div>
                        <div class="infrastructure-single-block">
    ...
    <div id="faq" class="navigation-target">
        <div style="background-image: url(&quot;img/question-answer-background.jpg&quot;)" class="question-answer">
            ...
            <div class="question-answer-slider">
                <div class="question-answer-slide">
                    <div class="question-answer-slide-content">
                        <h2>У вас будет комфортный режим общения с риэлтором, который разберется в вашей ситуации?</h2>
                        <p>У вас будет комфортный режим общения с риэлтором, который разберется в вашей ситуации, выявит ваши потребности и предложит варианты недвижимости с учетом ваших пожеланий.</p>
                    </div>
                </div>
                <div class="question-answer-slide">
                    <div class="question-answer-slide-content">
            ...
            <div class="documents-slider-container">
                <div class="documents-slider">
                    <div class="documents-slide">
                        <div style="background-image: url(&quot;img/document-image.jpg&quot;)" class="document-image popup-target-image"></div>
                    </div>
                    <div class="documents-slide">
                        <div style="background-image: url(&quot;img/document-image.jpg&quot;)" class="document-image popup-target-image"></div>
                    </div>
            ...
            <div class="padding-content">
                <div class="cotages-landing-link">
                    <div class="left-block">
                        <h1>построим дом вашей мечты “ПОД КЛЮЧ”</h1>
                    </div>
                    <div class="right-block">
                        <p>Выгоды подхода от «нуля» и вплоть до сдачи объекта «под ключ» очевидны не только с точки зрения интересов бизнеса, но, прежде всего, с позиции потребителя. Последний может быть уверен в том, что получит высококачественный продукт
                            в одном месте — готовый дом,весь комплекс интерьерно-отделочных работ, придомовую территорию и необходимые наружные инженерные сети. Все процессы контролируются из единого центра решений и не нуждаются в сложных согласованиях.</p>
                        <a
